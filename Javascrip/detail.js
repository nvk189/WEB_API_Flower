  ...
  $scope.Detail = function () {
    $http({
      ...
      $http({
        ...
        var index = $scope.detailitem.findIndex(item => item.maSanPham === $scope.listdetail.maSanPham);
...
if (index !== -1) {
    ...
    localStorage.setItem('cartItem_' + customerId, JSON.stringify($scope.list));
    $scope.list = JSON.parse(localStorage.getItem('cartItem_' + customerId));
